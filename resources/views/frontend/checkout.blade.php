      ...
      <div class="xl:px-[60px]">
        ...
        <div class="flex flex-wrap items-center justify-center gap-y-[30px] lg:justify-between lg:items-start">
          <div class="max-w-[500px]">
            <img src="{{ asset($event->thumbnail) }}" class="w-[280px] h-[200px] rounded-2xl"
                 alt="tickety-assets">
          ...
          <form action="{{ route('checkout-pay') }}" method="POST" class="bg-primary p-5 rounded-2xl flex flex-col gap-5 max-w-[380px] w-full">
            @csrf
            @method('post')
            ...
            {{-- Manual Transfer --}}
            <div class="relative px-5 py-6 cursor-pointer bg-bluish-purple rounded-2xl">
            ...
            <input type="text" name="name" id="completeName" placeholder="name" value=""
                   class="text-black" hidden>
            <input type="email" name="email" id="emailAddress" placeholder="email" value=""
                   class="text-black" hidden>
